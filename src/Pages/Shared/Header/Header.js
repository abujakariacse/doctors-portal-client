...
const Header = ({ children }) => {
    ...
    const menuItems = <>
        ...
        <li>{user && <NavLink className='rounded-md h-10 mr-4 font-bold' to='/profile'>Hi, {user.displayName}</NavLink>}</li>
        <li>{user && <NavLink className='rounded-md h-10 mr-4 font-bold' to='/dashboard'>Dashboard</NavLink>}</li>
