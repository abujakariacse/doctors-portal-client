...
const Services = () => {
    ...
    return (
        <div className=''>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 px-6 lg:w-11/12 mx-auto mt-20'>
                {
                    services.map(service => <Service key={service._id} service={service}></Service>)
                }
            </div>
            <div>
                <div className="hero lg:w-2/3 mx-auto lg:mt-36">
                    <div className="hero-content grid grid-cols-1 lg:grid-cols-2 gap-10">
                        <img src={treatment} className="max-w-sm rounded-lg" alt='treatment' />
                        <div>
